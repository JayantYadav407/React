...
const SetmoreHealth = ({ user, onLogin, onNavigateSearch }) => {
    ...
    <section className="py-20 px-6 bg-white flex justify-center items-center">
      <div className="max-w-6xl w-full bg-[#f9fafb] rounded-2xl overflow-hidden shadow-sm border border-gray-100 flex flex-col md:flex-row items-center p-8 md:p-16 gap-12">
        <div className="flex-1 space-y-6">
          ...
          <button 
            className="bg-[#243931] text-white px-8 py-4 rounded-md font-bold text-sm hover:bg-[#2c463c] transition-colors duration-200" 
        ...
        <div className="flex-1 relative flex justify-center items-center">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <div className="tracking-[0.5em] text-[#1d2d35] font-light text-xl ml-2">HEALTH</div>
          </div>
